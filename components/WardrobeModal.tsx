...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
    ...
    const handleGarmentClick = async (item: WardrobeItem) => {
        ...
        try {
            ...
            const detailedError = `Không thể tải món đồ. Đây thường là lỗi CORS. Kiểm tra console của nhà phát triển để biết chi tiết.`;
  ...
  return (
    <div className="pt-6 border-t border-gray-400/50">
        ...
        {wardrobe.length === 0 && (
             <p className="text-center text-sm text-gray-500 mt-4">Trang phục bạn tải lên sẽ xuất hiện ở đây.</p>
        )}
